...
# Define Option Flags
COMPILER_FLAGS = -target=SN8P2711B -INI="D:\Sonix\SN8_C_~1.255\Bin\Build\SN8P2700A.ini" -PROJECTNAME=".\test.prj" -WL=3 -Chip_Series=2 -A -g -I.\Include -ID:\Sonix\SN8_C_~1.255\C\include -NoCALLHL -NoMUL -NoHL -NoX -PUSH2 -NoGlobalOpt -tempdir="$(OBJ_PATH)"  -cpp_skip_asm -DICE_Mode=0
GMA_FLAGS = /INI:"SN8P2700A.ini" /ID1:0 /ID2:0  /MACHINE:SN8P2711B  /Chip_Series:2 /NOPeephole: /PATH:".\Include" /PROJECTNAME:".\test.prj" /WL:3 /DEFINE:ICE_Mode=0 /DEFINE:SN8P2711B=1  /OutputPath:"$(OBJ_PATH)" 
LINK_FLAGS = /MACHINE:SN8P2711B /Chip_Series:2 /INI:"SN8P2700A.ini" /WL:3 /OutputFile:"$(OUT_PATH)/test.out"  /MAP:"$(OBJ_PATH)\test.map"   /LISTFILE:  /STDLIB:".\Obj"    /PATH:"$(LIB_PATH)" /STACK: /PROJECTNAME:".\test.prj"
CONV_FLAGS = /MACHINE:SN8P2711B /INI:"SN8P2700A.ini" /WL:3 /OutputFile:"$(OUT_PATH)/test.sn8"  /PROJECTNAME:".\test.prj" /IDSVersion:V1.20.219.255n /Chip_Series:2 /OSLIB:".\Obj"  
LINK_DEP_FILES = $(OBJ_PATH)\main.o $(OBJ_PATH)\key.o   \

# Define Rule
$(OBJ_PATH)\key.asm: .\Src\key.c $(C_INC_PATH)\SN8P2711B.h $(PRJ_PATH)\test.cfg
	@$(COMPILER) $(COMPILER_FLAGS) -o $@ $^ 

$(OBJ_PATH)\main.asm: .\Src\main.c $(C_INC_PATH)\SN8P2711B.h $(PRJ_PATH)\test.cfg
	@$(COMPILER) $(COMPILER_FLAGS) -o $@ $^ 
